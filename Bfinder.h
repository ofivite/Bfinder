...
//   int PdgIDatTruthLevel(reco::TrackRef Track, edm::Handle<reco::GenParticleCollection> genParticles, int &ParentID); // not used 
  ...
  std::vector<float>    *B_mass             , *B_mass_c0        , *B_mass_0c;
  ...
  std::vector<float>    *B_pion_px1         , *B_pion_py1       , *B_pion_pz1;
  std::vector<float>    *B_pion_charge1     , *pion1_trackchi2  , *pion1_Hits,  *pion1_PHits;
  std::vector<float>    *pion1_dxy_Bcdecay, *pion1_dz_Bcdecay, *pion1_NTrackerLayers,  *pion1_NPixelLayers, *pi1_Bcdecay_weight, *pi1_CommonVtx_weight;   
  ...
  std::vector<float>    *pion2_dxy_PV, *pion2_dz_PV, *pion2_dxy_Bcdecay, *pion2_dz_Bcdecay, *pion2_NTrackerLayers,  *pion2_NPixelLayers, *pi2_PV_weight, *pi2_CommonVtx_weight;
  ...
  std::vector<float>    *BcVertex_Chi, *BcVertex_normChi;
  std::vector<bool>	*CommonVtx_isValid;
  std::vector<float>    *CommonVtx_Chi, *CommonVtx_normChi, *comp_BcVtx_CommonVtx, *dist_BcVtx_CommonVtx, *DS_BcVtx_CommonVtx;
